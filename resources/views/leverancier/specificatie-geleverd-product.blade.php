...
@section('content')
    <div class="max-w-4xl mx-auto bg-white border border-gray-300 shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6 text-gray-800">
            <p><span class="font-semibold">Startdatum:</span>
                {{ $startDatum ? \Carbon\Carbon::parse($startDatum)->format('d-m-Y') : '-' }}</p>
            <p><span class="font-semibold">Einddatum:</span>
                {{ $eindDatum ? \Carbon\Carbon::parse($eindDatum)->format('d-m-Y') : '-' }}</p>
            ...
            <table class="min-w-full text-center border-collapse">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="2"
                                class="border border-gray-300 px-4 py-6 text-red-600 font-semibold bg-red-50">
        ...
        <div class="mt-6 flex gap-3">
            ...
            <a href="{{ route('home') }}"
                class="inline-flex items-center px-4 py-2 rounded bg-gray-800 text-white hover:bg-gray-900">
                Home
            </a>
        </div>
    </div>
